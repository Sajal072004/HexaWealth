...
const User = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl font-bold text-black"><span className="text-blue-600 ">User</span>Page</h1>
        ...
        {pendingPosts.length > 0 ? (
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full">
            ...
            {pendingPosts.map((post) => (
             ...
             { !post.isApproved && ( <div className="text-black">Status : <span className="text-red-500">Pending</span> </div>)}
             { post.isApproved && ( <div className="text-black">Status : <span className="text-green-500">Approved</span> </div>)}
